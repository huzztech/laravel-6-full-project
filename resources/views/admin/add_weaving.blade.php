...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="{{url('home/program/add')}}" method="post">
                @csrf
                <div class="card-body">
                  ...
                  <input type="Date" id="set_date" name="set_date" class="form-control col-md-12 col-xs-12" value="{{date('Y-m-d')}}" style="background: #ffffff;">
                 </div>

                  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                  <label for="code">Code <span class="required">*</span></label>
                  <input type="text" id="code" name="code" required="required" class="form-control col-md-12 col-xs-12" style="background: #ffffff;" value="{{old('code')}}">
                 </div>
            ...
            <select class="form-control col-md-12 col-xs-12" name="customer" required="" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$company->id}}" {{ old('customer') == $company->id ? 'selected="selected"' : '' }}>{{$company->name}}</option>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                ...
                <option value="{{$unit->id}}" {{ old('unit') == $unit->id ? 'selected="selected"' : '' }}>{{$unit->name}}</option>
            ...
            <tr>
              ...
              <select class="form-control col-md-12 col-xs-12" name="warp_count" required="" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$w_extra1->name}}" {{ old('warp_count') == $w_extra1->name ? 'selected="selected"' : '' }}>{{$w_extra1->name}}</option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="warp_yarn_type" style="width: 97%; margin-bottom: 10px;" required="">
                ...
                <option value="{{$w_extra2->name}}" {{ old('warp_yarn_type') == $w_extra2->name ? 'selected="selected"' : '' }}>{{$w_extra2->name}}</option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="warp_yarn_blend" style="width: 97%; margin-bottom: 10px;" required="">
               ...
               @foreach($w_extras3 as $w_extra3)
                ...
                <option value="{{$w_extra3->name}}" {{ old('warp_yarn_blend') == $w_extra3->name ? 'selected="selected"' : '' }}>{{$w_extra3->name}}</option>
            ...
            <tr>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft1_count" style="width: 97%; margin-bottom: 10px;" required="">
                ...
                <option value="{{$w_extra1->name}}" {{ old('weft1_count') == $w_extra1->name ? 'selected="selected"' : '' }}>{{$w_extra1->name}}</option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft1_yarn_type" style="width: 97%; margin-bottom: 10px;" required="">
                ...
                <option value="{{$w_extra2->name}}" {{ old('weft1_yarn_type') == $w_extra2->name ? 'selected="selected"' : '' }}>{{$w_extra2->name}}</option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft1_yarn_blend" style="width: 97%; margin-bottom: 10px;" required="">
                ...
                <option value="{{$w_extra3->name}}" {{ old('weft1_yarn_blend') == $w_extra3->name ? 'selected="selected"' : '' }}>{{$w_extra3->name}}</option>
            ...
            <tr>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft2_count" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$w_extra1->name}}" {{ old('weft2_count') == $w_extra1->name ? 'selected="selected"' : '' }}>{{$w_extra1->name}}</option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft2_yarn_type" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$w_extra2->name}}" {{ old('weft2_yarn_type') == $w_extra2->name ? 'selected="selected"' : '' }}>{{$w_extra2->name}}</option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft2_yarn_blend" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$w_extra3->name}}" {{ old('weft2_yarn_blend') == $w_extra3->name ? 'selected="selected"' : '' }}>{{$w_extra3->name}}</option>
            ...
            <tr>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft3_count" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$w_extra1->name}}" {{ old('weft3_count') == $w_extra1->name ? 'selected="selected"' : '' }}>{{$w_extra1->name}}</option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft3_yarn_type" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$w_extra2->name}}" {{ old('weft3_yarn_type') == $w_extra2->name ? 'selected="selected"' : '' }}>{{$w_extra2->name}}</option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft3_yarn_blend" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$w_extra3->name}}" {{ old('weft3_yarn_blend') == $w_extra3->name ? 'selected="selected"' : '' }}>{{$w_extra3->name}}</option>
            ...
            <tr>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft4_count" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$w_extra1->name}}" {{ old('weft4_count') == $w_extra1->name ? 'selected="selected"' : '' }}>{{$w_extra1->name}}</option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft4_yarn_type" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$w_extra2->name}}" {{ old('weft4_yarn_type') == $w_extra2->name ? 'selected="selected"' : '' }}>{{$w_extra2->name}}</option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft4_yarn_blend" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="{{$w_extra3->name}}" {{ old('weft4_yarn_blend') == $w_extra3->name ? 'selected="selected"' : '' }}>{{$w_extra3->name}}</option>
              ...
              <input type="text" id="w_end" name="w_end" required="required" class="form-control col-md-12 col-xs-12" value="{{old('w_end')}}">
              </div>

              <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <label for="w_pick">Pick <span class="required">*</span></label>
            <input type="text" id="w_pick" name="w_pick" required="required" class="form-control col-md-12 col-xs-12" value="{{old('w_pick')}}">
            </div>


            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <label for="w_width">Width " <span class="required">*</span></label>
            <input type="text" id="w_width" name="w_width" required="required" class="form-control col-md-12 col-xs-12" value="{{old('w_width')}}">
            </div>
            ...
            <select class="form-control col-md-12 col-xs-12" name="w_fabric_type" required="">
                ...
                <option value="{{$w_extra4->name}}" {{ old('w_fabric_type') == $w_extra4->name ? 'selected="selected"' : '' }}>{{$w_extra4->name}}</option>
            ...
            <select class="form-control col-md-12 col-xs-12" name="w_selvedge" required="">
                ...
                <option value="{{$w_extra5->name}}"  {{ old('w_selvedge') == $w_extra5->name ? 'selected="selected"' : '' }}>{{$w_extra5->name}}</option>
            ...
            <select class="form-control col-md-12 col-xs-12" name="w_writing" required="">
                ...
                <option value="">Select</option>
                <option value="Yes"  {{ old('w_writing') == "Yes" ? 'selected="selected"' : '' }}>Yes</option>
                <option value="No"  {{ old('w_writing') == "No" ? 'selected="selected"' : '' }}>No</option>
              ...
              <textarea class="form-control col-md-12 col-xs-12" name="remarks">{{old('remarks')}}</textarea>
              </div>
