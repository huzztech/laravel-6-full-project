...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Program Detail ({{$programs->code}}) </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <div class="col-md-12">
              ...
              @if(count($errors) > 0)
               ...
               @if (session('message'))
                ...
                @endif
                   ...
                   {{$programs->code . ' | ' . $programs->etm_code}}                       
                    
                    {{  $programs->warp_count . 'x' . $programs->weft1_count . $programs->weft2_count . $programs->weft3_count . $programs->weft4_count. '/'. $programs->w_end. 'x'. $programs->w_pick. '-'. $programs->w_width}}" {{$programs->w_fabric_type}}  {{$programs->w_selvedge}} {{$programs->remarks}}
          ...
          <div class="col-md-12 col-sm-9 col-xs-12">
                           ...
                           <div class="adjustscrollsode" style="overflow: hidden scroll; width: 48%; float: left; height: 693px; margin-top: 20px;">
                            ...
                            <table class="data table table-striped no-margin heightment" style="font-family: 'calibri'; font-size: 14px; width: 100%;">
                              ...
                              <tbody>
                               ...
                               <tr style="cursor: pointer;" onclick="openlog('jddywrq8u4lsykp2ftpj9egn8b2tc4fio1fs1w9a2koaa2oy3gw97U1RHLTI3NA==1wxpkjriexfd8hef9j4pv53vnxhj8j3c4hghct7y2af28j3qcaxl337jor7qkqy8', '8t04n36thl0i355pyupot4qgphnp6p0vjwapm3dym1gio29rs5r0rc2VsdmVkZ2VfY29sb3I=w3pjg81k6735c9r6prk4i6x53e3uj34u7uvri78sqosb34c3mfwwg3qkutlll8q2')">
                                  ...
                                  <td>                                  
                                   ...
                                   <span class="editmywritingname_text_a9"> {{ $programs->selvedge_color }}  </span>
                                                                                        
                                  <input type="text" name="mywritingname_a9" value="{{ $programs->selvedge_color }}" class="mywritingname_a9" id="mywritingname_a9" style="display: none;">
                              ...
                              <tr style="cursor: pointer;" onclick="openlog('jddywrq8u4lsykp2ftpj9egn8b2tc4fio1fs1w9a2koaa2oy3gw97U1RHLTI3NA==1wxpkjriexfd8hef9j4pv53vnxhj8j3c4hghct7y2af28j3qcaxl337jor7qkqy8', '9nuyc26reb5h4c4brcmje657rlort7njk05gejw2epwcbtzrwv7rrb3JkZXJfcXVhbnRpdHk=decelxmi83tqrzd45c26gol95xdhl54lr9pel6l6w5cqnrnkzhvq78lexn2jnhpt')">
                                  ...
                                  <span class="editmywritingname_text_a2"> {{ $programs->order_quantity }} </span>
                                   
                                   <input type="text" name="mywritingname_a2" value="{{ $programs->order_quantity }}" class="mywritingname_a2" id="mywritingname_a2" style="display: none;">
                                ...
                                <tr style="cursor: pointer;" onclick="openlog('jddywrq8u4lsykp2ftpj9egn8b2tc4fio1fs1w9a2koaa2oy3gw97U1RHLTI3NA==1wxpkjriexfd8hef9j4pv53vnxhj8j3c4hghct7y2af28j3qcaxl337jor7qkqy8', 'es4r9pb0jpqedq9i5ppos6lkpka1akgcxndble2ys7joduzq99ek8c2FtcGxlX3dvcmQ=q2xzp2u1dv9hp3gdzu7n9jc36nu1dkce331gni2nhrqsf8mpi6twvrcgcd15vl8m')">
                                 ...
                                 <span class="editmywritingname_text_a7"> {{ $programs->design_status }} </span>
                                   
                                  <span class="editmywritingname_text_a7_2" style="margin-left: 10px;"> {{ \Carbon\Carbon::parse($programs->design_status_date)->format('d-M-y')}}</span>
                  ...
                  <option value="Pending" {{ $programs->design_status == 'Pending' ? 'selected="selected"' : '' }}>Pending</option>
                  <option value="Received" {{ $programs->design_status == 'Received' ? 'selected="selected"' : '' }}>Received</option>
                  <option value="Approved" {{ $programs->design_status == 'Approved' ? 'selected="selected"' : '' }}>Approved</option>
                   
                    </select>
                                     
                                  <input type="text" name="mywritingname_a7_2" value="{{ \Carbon\Carbon::parse($programs->design_status_date)->format('d-M-y')}}" class="mywritingname_a7_2 hasDatepicker" id="mywritingname_a7_2" style="width: 30%;display: none;" readonly="">
                                ...
                                <tr style="cursor: pointer;" onclick="openlog('jddywrq8u4lsykp2ftpj9egn8b2tc4fio1fs1w9a2koaa2oy3gw97U1RHLTI3NA==1wxpkjriexfd8hef9j4pv53vnxhj8j3c4hghct7y2af28j3qcaxl337jor7qkqy8', 'jd9m1t8yrbtwsl3kfpln094nv2wa79pli4lwwo9gailix7k5hg3l9c3R5bGVfaWQ=09o21rekwqr9zyclufo3u29ez0h23xn44snat174eobospm6de8fxef1ppk0kdth')">
                                  ...
                                  <span class="editmywritingname_text_a14"> {{ $programs->style_id }} </span>
                                   
                                   <input type="text" name="mywritingname_a14" value="{{ $programs->style_id }}" class="mywritingname_a14" id="mywritingname_a14" style="display: none;">                  
                                 ...
                                 <tr style="cursor: pointer;" onclick="openlog('jddywrq8u4lsykp2ftpj9egn8b2tc4fio1fs1w9a2koaa2oy3gw97U1RHLTI3NA==1wxpkjriexfd8hef9j4pv53vnxhj8j3c4hghct7y2af28j3qcaxl337jor7qkqy8', 'hd6ed0gyay1taml4zwwiqya1j4z4bnxsdp1qdmwvuo9thwwusem7bbG9vbXM=jx95bxu2jxntybu93uqpl24kx5irh3wg42qlj17jlawmmmboji4awrasbipvwy48')">
                                  ...
                                  <span class="editmywritingname_text_a11"> {{ $programs->looms }} </span>
                  ...
                  @for($wewe = 1; $wewe <= 20; $wewe++)


                  <option value="{{ $wewe }}" {{ $programs->looms == $wewe ? 'selected="selected"' : '' }}>{{ $wewe }}</option>
                  ...
                  @endfor
                                   ...
                                   <input type="text" name="mywritingname_a11" value="{{ $programs->looms }}" class="mywritingname_a11" id="mywritingname_a11" style="display: none;">
                                 ...
                                 <span class="editmywritingname_text_a12"> {{ \Carbon\Carbon::parse($programs->closing_date)->format('d-M-y')}} </span>
                                      
                                   <input type="text" name="mywritingname_a12" value="{{ \Carbon\Carbon::parse($programs->closing_date)->format('d-M-y')}}" class="mywritingname_a12 hasDatepicker" id="mywritingname_a12" style="display: none;" readonly="">
                                 ...
                                 <span class="editmywritingname_text_a13"> {{ $programs->produced_quantity }} </span>
                                   
                                   <input type="text" name="mywritingname_a13" value="{{ $programs->produced_quantity }}" class="mywritingname_a13" id="mywritingname_a13" style="display: none;">
                                 ...
                                 <tr style="cursor: pointer;" onclick="openlog('jddywrq8u4lsykp2ftpj9egn8b2tc4fio1fs1w9a2koaa2oy3gw97U1RHLTI3NA==1wxpkjriexfd8hef9j4pv53vnxhj8j3c4hghct7y2af28j3qcaxl337jor7qkqy8', '8u7kuzowg0fz56lzmgext8d2wxnqj2rcjibm4fgj2xvjfvh0w3a0yZGlzcGF0Y2hfcXVhbnRpdHk=fpkih6dh3w61z1li7dbda83mbbiu6g3d0ke4h3q8x3oriopais5tdnkj0117nvi6')">
                                  ...
                                  <span class="editmywritingname_text_a5"> {{ $programs->dispatch_quantity }} </span>
                                   
                                   <input type="text" name="mywritingname_a5" value="{{ $programs->dispatch_quantity }}" class="mywritingname_a5" id="mywritingname_a5" style="display: none;">
                  ...
                  <tr style="cursor: pointer;" onclick="openlog('jddywrq8u4lsykp2ftpj9egn8b2tc4fio1fs1w9a2koaa2oy3gw97U1RHLTI3NA==1wxpkjriexfd8hef9j4pv53vnxhj8j3c4hghct7y2af28j3qcaxl337jor7qkqy8', '58sxfwbhggybsh35rpdi2apnkpy5khn9kydygwby2cw5qqf66wj5aZGlzcGF0Y2hfZGF0ZQ==qgrhzuuvi1lemavmtwbl6lqditnzciklwvc36gavmcp71rlz8o64lae3oggtwrm8')">
                                 ...
                                 <span class="editmywritingname_text_a8"> {{ \Carbon\Carbon::parse($programs->dispatch_date)->format('d-M-y')}} </span>
                                   
                                   <input type="text" name="mywritingname_a8" value="{{ \Carbon\Carbon::parse($programs->dispatch_date)->format('d-M-y')}}" class="mywritingname_a8 hasDatepicker" id="mywritingname_a8" readonly="" style="display: none;">
                                  ...
                                  <span class="editmywritingname_text_a4"> {{ $programs->dispatch_address }} </span>
                                   
                                   <input type="text" name="mywritingname_a4" value="{{ $programs->dispatch_address }}" class="mywritingname_a4" id="mywritingname_a4" style="display: none;">
                                 ...
                                 <tr style="cursor: pointer;" onclick="openlog('jddywrq8u4lsykp2ftpj9egn8b2tc4fio1fs1w9a2koaa2oy3gw97U1RHLTI3NA==1wxpkjriexfd8hef9j4pv53vnxhj8j3c4hghct7y2af28j3qcaxl337jor7qkqy8', 'mps9kvqbepraxu0b9zpfnmmlkcy0dk9hmrzyk1g88r5ag3tepr318ZGVsaXZlcmVkX3F1YW50aXR5ud5sabq02763rtnde0xdu6cggpmtlbxasw0oz1v9200hd4r4sq6jwvzh2vver6fm')">
                                  ...
                                  <span class="editmywritingname_text_a10"> {{ $programs->delivered_quantity }} </span>
                                   
                                   <input type="text" name="mywritingname_a10" value="{{ $programs->delivered_quantity }}" class="mywritingname_a10" id="mywritingname_a10" style="display: none;">
               ...
               <span class="editmywritingname_text_a6"> {{ $programs->stock_quantity }}  </span>
              
              <!--<input type="text" name="mywritingname_a6" value="{{ $programs->stock_quantity }}" class="mywritingname_a6" id="mywritingname_a6" />-->
                ...
                <tr>
                 ...
                 <span> {{ $programs->stock_at_stm }}  </span>
              ...
              <span class="editmywritingname_text_a15"> {{ $programs->notes_for_us }} </span>
