...
<head>
	...
	<link rel="icon" href="{{ url('img/favico.jpg') }}" type="image/png">
	...
	<link rel="stylesheet" href="{{ asset('landing/vendors/flaticon/flaticon.css') }}">
	<!-- main css -->
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="{{ url('/') }}"><h2>HuzzTech Laravel Software</h2><!--<img src="{{ url('img/colorlogo33.jpg') }}" alt="" style="width: 235px;">--></a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav justify-content-center">
							<li class="nav-item"><a class="nav-link" href="{{ url('/') }}">Generate Program</a></li>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="nav-item"><a href="{{ url('/register') }}" class="primary_btn text-uppercase">free trial</a></li>
						</ul>
					</div>
				</div>
			</nav>
			...
			<div class="row footer_inner">
				<div class="col-lg-4 col-sm-6">
					<aside class="f_widget ab_widget">
						...
						<p>
				&copy; {{date('Y')}} All rights reserved | HuzzTech</p>
					</aside>
				</div>
				<div class="col-lg-4 col-sm-6">
