...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?php echo e(url('home/program/add')); ?>" method="post">
                ...
                <div class="card-body">
                  ...
                  <input type="Date" id="set_date" name="set_date" class="form-control col-md-12 col-xs-12" value="<?php echo e(date('Y-m-d')); ?>" style="background: #ffffff;">
                 </div>

                  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                  <label for="code">Code <span class="required">*</span></label>
                  <input type="text" id="code" name="code" required="required" class="form-control col-md-12 col-xs-12" style="background: #ffffff;" value="<?php echo e(old('code')); ?>">
                 </div>
            ...
            <select class="form-control col-md-12 col-xs-12" name="customer" required="" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($company->id); ?>" <?php echo e(old('customer') == $company->id ? 'selected="selected"' : ''); ?>><?php echo e($company->name); ?></option>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                ...
                <option value="<?php echo e($unit->id); ?>" <?php echo e(old('unit') == $unit->id ? 'selected="selected"' : ''); ?>><?php echo e($unit->name); ?></option>
            ...
            <tr>
              ...
              <select class="form-control col-md-12 col-xs-12" name="warp_count" required="" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($w_extra1->name); ?>" <?php echo e(old('warp_count') == $w_extra1->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra1->name); ?></option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="warp_yarn_type" style="width: 97%; margin-bottom: 10px;" required="">
                ...
                <option value="<?php echo e($w_extra2->name); ?>" <?php echo e(old('warp_yarn_type') == $w_extra2->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra2->name); ?></option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="warp_yarn_blend" style="width: 97%; margin-bottom: 10px;" required="">
               ...
               <?php $__currentLoopData = $w_extras3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w_extra3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <option value="<?php echo e($w_extra3->name); ?>" <?php echo e(old('warp_yarn_blend') == $w_extra3->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra3->name); ?></option>
            ...
            <tr>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft1_count" style="width: 97%; margin-bottom: 10px;" required="">
                ...
                <option value="<?php echo e($w_extra1->name); ?>" <?php echo e(old('weft1_count') == $w_extra1->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra1->name); ?></option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft1_yarn_type" style="width: 97%; margin-bottom: 10px;" required="">
                ...
                <option value="<?php echo e($w_extra2->name); ?>" <?php echo e(old('weft1_yarn_type') == $w_extra2->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra2->name); ?></option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft1_yarn_blend" style="width: 97%; margin-bottom: 10px;" required="">
                ...
                <option value="<?php echo e($w_extra3->name); ?>" <?php echo e(old('weft1_yarn_blend') == $w_extra3->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra3->name); ?></option>
            ...
            <tr>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft2_count" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($w_extra1->name); ?>" <?php echo e(old('weft2_count') == $w_extra1->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra1->name); ?></option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft2_yarn_type" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($w_extra2->name); ?>" <?php echo e(old('weft2_yarn_type') == $w_extra2->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra2->name); ?></option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft2_yarn_blend" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($w_extra3->name); ?>" <?php echo e(old('weft2_yarn_blend') == $w_extra3->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra3->name); ?></option>
            ...
            <tr>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft3_count" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($w_extra1->name); ?>" <?php echo e(old('weft3_count') == $w_extra1->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra1->name); ?></option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft3_yarn_type" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($w_extra2->name); ?>" <?php echo e(old('weft3_yarn_type') == $w_extra2->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra2->name); ?></option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft3_yarn_blend" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($w_extra3->name); ?>" <?php echo e(old('weft3_yarn_blend') == $w_extra3->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra3->name); ?></option>
            ...
            <tr>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft4_count" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($w_extra1->name); ?>" <?php echo e(old('weft4_count') == $w_extra1->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra1->name); ?></option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft4_yarn_type" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($w_extra2->name); ?>" <?php echo e(old('weft4_yarn_type') == $w_extra2->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra2->name); ?></option>
              ...
              <select class="form-control col-md-12 col-xs-12" name="weft4_yarn_blend" style="width: 97%; margin-bottom: 10px;">
                ...
                <option value="<?php echo e($w_extra3->name); ?>" <?php echo e(old('weft4_yarn_blend') == $w_extra3->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra3->name); ?></option>
              ...
              <input type="text" id="w_end" name="w_end" required="required" class="form-control col-md-12 col-xs-12" value="<?php echo e(old('w_end')); ?>">
              </div>

              <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <label for="w_pick">Pick <span class="required">*</span></label>
            <input type="text" id="w_pick" name="w_pick" required="required" class="form-control col-md-12 col-xs-12" value="<?php echo e(old('w_pick')); ?>">
            </div>


            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <label for="w_width">Width " <span class="required">*</span></label>
            <input type="text" id="w_width" name="w_width" required="required" class="form-control col-md-12 col-xs-12" value="<?php echo e(old('w_width')); ?>">
            </div>
            ...
            <select class="form-control col-md-12 col-xs-12" name="w_fabric_type" required="">
                ...
                <option value="<?php echo e($w_extra4->name); ?>" <?php echo e(old('w_fabric_type') == $w_extra4->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra4->name); ?></option>
            ...
            <select class="form-control col-md-12 col-xs-12" name="w_selvedge" required="">
                ...
                <option value="<?php echo e($w_extra5->name); ?>"  <?php echo e(old('w_selvedge') == $w_extra5->name ? 'selected="selected"' : ''); ?>><?php echo e($w_extra5->name); ?></option>
            ...
            <select class="form-control col-md-12 col-xs-12" name="w_writing" required="">
                ...
                <option value="">Select</option>
                <option value="Yes"  <?php echo e(old('w_writing') == "Yes" ? 'selected="selected"' : ''); ?>>Yes</option>
                <option value="No"  <?php echo e(old('w_writing') == "No" ? 'selected="selected"' : ''); ?>>No</option>
              ...
              <textarea class="form-control col-md-12 col-xs-12" name="remarks"><?php echo e(old('remarks')); ?></textarea>
              </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\l6app\resources\views/admin/add_weaving.blade.php ENDPATH**/ ?>