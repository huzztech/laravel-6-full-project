            ...
            <div class="card card-primary">
              ...
              <form action="<?php echo e(url('home/program/update')); ?>" method="post" role="form">
                ...
                <div class="card-body">
                  ...
                  <input type="text" id="code" name="code" required="required" class="form-control col-md-12 col-xs-12" value="<?php echo e($programs->code); ?>" style="background: #ffffff;" readonly="">
                 </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\l6app\resources\views/admin/edit_weaving.blade.php ENDPATH**/ ?>