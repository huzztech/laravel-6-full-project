...
<head>
  ...
  <title>HuzzTech - <?php echo $__env->yieldContent('title'); ?></title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3" method="get" action="<?php echo e(url('home/program/search')); ?>">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <!--<a href="#" class="dropdown-item">
             Message Start -->
          <!--  <div class="media">
              <img src="<?php echo e(asset('public/dist/img/user1-128x128.jpg')); ?>" alt="User Avatar" class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo e(url('/')); ?>" class="brand-link">
      <img src="<?php echo e(asset('public/dist/img/AdminLTELogo.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo e(asset('public/dist/img/profile11.png')); ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="<?php echo e(url('/home/profile/')); ?>" class="d-block"><?php echo e(Auth::user()->name); ?></a>
        </div>
      </div>
         ...
         ?>
          ...
          <li class="nav-item has-treeview
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/home/profile')); ?>" class="nav-link  
              <?php if($segment == 'profile' && $segment3 != 'edit'): ?>
              active
              <?php endif; ?>">
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('/home/profile/edit')); ?>" class="nav-link  
              <?php if($segment3 == 'edit'): ?>
              active
              <?php endif; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Change Password</p>
           ...
           <li class="nav-item has-treeview
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/home/program/add')); ?>" class="nav-link
              <?php if($segment == 'program' && $segment3 == 'add'): ?>
              active
              <?php endif; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add</p>
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('/home/program/view')); ?>" class="nav-link  
              <?php if($segment == 'program' && $segment3 == 'view'): ?>
              active
              <?php endif; ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View</p>
  ...
  <?php echo $__env->yieldContent('specificpagecontent'); ?>

  
  <!-- /.content-wrapper -->
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo e(date('Y')); ?> Developed by <a href="http://huzztech.com/">HuzzTech</a>.</strong>
    All rights reserved.
...
<?php echo $__env->yieldContent('specificjavascript'); ?>
...
<?php /**PATH F:\wamp64\www\l6app\resources\views/layouts/admin.blade.php ENDPATH**/ ?>